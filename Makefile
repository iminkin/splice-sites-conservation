...
$(unique_exons): $(gencode_exons) $(refseq_exons) $(chess_exons) $(mane_exons)
	$(PYTHON_INTERPRETER) src/data/unique_exons.py $(gencode_dir)/exons/$(@F) $(refseq_dir)/exons/$(@F) $(chess_dir)/exons/$(@F) $(mane_dir)/exons/$(@F) > $(realignment_dir)/unique_exons/$(@F)
