...
feature = {"d" : clipped_range(15, 47), "a" : clipped_range(15, 47)}
#feature = {"d" : clipped_range(0, 61), "a" : clipped_range(0, 61)}
print(feature)
...
def train_model(data, end, roc_dir):
	...
	roc_handle = open(os.path.join(roc_dir, "roc_" + end + ".txt"), "w")
